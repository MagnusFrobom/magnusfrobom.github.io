...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>MagnusFröbom</title>
        <meta name="description" content="Generated by MagnusFröbom" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="font-burtons text-xl">MF</h1>
            <ul className="flex items-center">
              ...
              <li>
                <a
                  className="bg-gradient-to-br from-teal-400 text- to-cyan-800 text-white px-4 py-2 border-none rounded-md ml-10"
                  href=""
                >
                  Resume
                </a>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              ...
              <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              Reading books and hacking social-media algorithms for personal growth and development. There's always something to get better at.
            </p>
            </p>
          </div>
